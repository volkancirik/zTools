...
urlpatterns = patterns('',
    ...
    (r'^export_shipments_excel/$', 'cross_app.sms.views.export_shipments_excel'),
    (r'^export_a_shipment_excel/$', 'cross_app.sms.views.export_a_shipment_excel'),
    (r'^export_basket_excel/$', 'cross_app.sms.views.export_basket_excel'),
    (r'^empty_basket/$', 'cross_app.sms.views.empty_basket'),
