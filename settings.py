# Django settings for cross_dock_order project.
...
SECRET_KEY = 'vnjllsk7rqxluq%oh$t@o%ze74x6ip&$le%h0x41d!w5gwt7on'
...
ROOT_URLCONF = 'cross_dock_order.urls'
